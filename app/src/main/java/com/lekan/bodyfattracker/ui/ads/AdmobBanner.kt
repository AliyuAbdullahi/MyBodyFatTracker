...
@Composable
fun AdmobFullPage(modifier: Modifier, adUnitId: String = "ca-app-pub-3940256099942544/6300978111", onAdCompletion: () -> Unit) {
    AndroidView(
        modifier = modifier.fillMaxWidth(),
        factory = { context ->
            AdView(context).apply {
                setAdSize(AdSize.FULL_BANNER) // Or other AdSize like AdSize.LARGE_BANNER, AdSize.FULL_BANNER
                // Or AdSize.getCurrentOrientationAnchoredAdaptiveBannerAdSize(context, width)
                // Use test ad unit ID during development
                // Replace with your actual ad unit ID for release
                this.adUnitId = adUnitId // "ca-app-pub-3940256099942544/6300978111" is a test ID
