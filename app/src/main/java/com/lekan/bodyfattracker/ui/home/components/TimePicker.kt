...
fun TimePickerDialog(
    ...
    timeState: TimePickerState = rememberTimePickerState(
        initialHour = Calendar.getInstance().apply { timeInMillis = System.currentTimeMillis() }[Calendar.HOUR_OF_DAY],
        initialMinute = Calendar.getInstance().apply { timeInMillis = System.currentTimeMillis() }[Calendar.MINUTE],
    ),
